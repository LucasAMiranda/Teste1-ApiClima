...
CACHES = {
    'default': {
        #'BACKEND': 'django_redis.cache.RedisCache', #em produção
        'BACKEND': 'django.core.cache.backends.locmem.LocMemCache', #em desenvolvimento
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '100/hour', # 100 requisições por hora para IPs anônimos
